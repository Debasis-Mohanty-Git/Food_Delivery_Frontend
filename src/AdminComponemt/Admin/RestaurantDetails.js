  ...
  return (
    <div className='lg:px-20 px-5'>
      <div className='py-5 flex justify-center items-center gap-5'>
        ...
        <div>
          <Button className='py-[1rem] px-[2rem]' color={true ? "primary" : "error"}
          ...
          <CardContent>
            <div className="space-y-4 text-gray-200">
              ...
              <div className="flex">
                ...
                <p className="text-gray-400">- Debasis Mohanty</p>
              </div>

              <div className="flex">
                <p className="w-48 font-medium">Restaurant Name</p>
                <p className="text-gray-400">- Spicy Kitchen</p>
              </div>

              <div className="flex">
                <p className="w-48 font-medium">Cuisine Type</p>
                <p className="text-gray-400">- Indian, Fast Food</p>
              </div>
            ...
            <CardContent>
              <div className="space-y-4 text-gray-200">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-400">- 000000</p>
                </div>

                <div className="flex">
                  <p className="w-48 font-medium">Street Address</p>
                  <p className="text-gray-400">- Infocity, Patia, Bishnupriyanagar</p>
                </div>
            ...
            <CardContent>
              <div className="space-y-3 text-gray-200">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-400">- debasis@gmail.com</p>
                </div>

                <div className="flex">
                  <p className="w-48 font-medium">Mobile</p>
                  <p className="text-gray-400">- 8260800620</p>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex gap-3 text-gray-400">
                    ...
                    <a href="#"><WhatsAppIcon sx={{ fontSize: "2rem" }} /></a>
